package org.demo.consumer.feign.controller;

import org.demo.consumer.feign.feign.DcClient;
 ...
 * ，在Dalston版本中，Feign的Hystrix默认是关闭的。待后文介绍Hystrix带领大家入门之后
 * ，我们再结合介绍Feign中的Hystrix以及配置方式。
 * 
 * @author cgj
 *
 */
